...
public class CommandLine {
    ...
    private void runAI(String str) throws IOException {
    ...
    public void parse(String str) throws IOException {
        switch (str) {
            ...
            case "runcases":
                ...
                double num = new File("testCases/runData/data" + alg).list().length;
                
                File f = new File("testCases/runData/data" + alg + "/" + (int) num);
                ...
                for (int i = 0; i < c; i++) {
                    System.out.print("(" + i + ")\n");
                    load("testCases/cluster/" + clusters[i]);
                    runAI(alg);

                    fw.write("  Shot Count: " + shotCount + "\n");

                    totShots += shotCount;
                } fw.write("Cluster shot count:" + totShots + "\n");
                ...
                for (int i = 0; i < nc; i++) {
                    System.out.print("(" + i + ")\n");
                    load("testCases/nonCluster/" + nonClusters[i]);
                    runAI(alg);
                ...
                } fw.write("Non Cluster shot count: " + totNCShots + "\n");

                double avg = totShots / (c + nc);
                
                fw.write("\nRuns Completed: " + (int) (c + nc) + "\n");
                fw.write("Average shot count: " + avg);
                fw.close();
